...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "ScriptForge AI transforms rough scripts into cinematic English screenplays and generates emotion-aware voice narration." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "ScriptForge AI transforms rough scripts into cinematic English screenplays and generates emotion-aware voice narration." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "ScriptForge AI transforms rough scripts into cinematic English screenplays and generates emotion-aware voice narration." },
